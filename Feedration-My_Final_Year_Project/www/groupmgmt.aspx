<%@ Page Language="C#" AutoEventWireup="true" CodeFile="groupmgmt.aspx.cs" Inherits="groupmgmt" %>
...
&nbsp;&nbsp;&nbsp;
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td class="style2" valign="top">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label 
                        ID="Label1" runat="server" Text="Group"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <br />
                    <asp:TextBox ID="Group_edt" runat="server" Width="104px"></asp:TextBox>
    ...
    <p>
        <br />
        <asp:GridView ID="Groupmgmt_grid" runat="server" AutoGenerateColumns="False" 
            ...
            DataSourceID="SqlDataSource1" onrowcommand="Groupmgmt_grid_RowCommand" 
            onrowupdating="Groupmgmt_grid_RowUpdating" DataKeyNames="ID">
            ...
            <Columns>
                ...
                <asp:ButtonField CommandName="Delete_group" Text="Delete" />
            </Columns>
        </asp:GridView>
    </p>
