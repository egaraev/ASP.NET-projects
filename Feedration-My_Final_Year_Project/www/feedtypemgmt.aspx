<%@ Page Language="C#" AutoEventWireup="true" CodeFile="feedtypemgmt.aspx.cs" Inherits="feedtypemgmt" %>
...
&nbsp;&nbsp;&nbsp;
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td class="style2" valign="top">
                    &nbsp;&nbsp;&nbsp;<asp:Label 
                        ID="Label1" runat="server" Text="Feed category"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <br />
                    <asp:TextBox ID="Feedcat_edt" runat="server" Width="104px"></asp:TextBox>
    ...
    <p>
        <br />
        <asp:GridView ID="Feedcatmgmt_grid" runat="server" AutoGenerateColumns="False" 
            ...
            DataSourceID="SqlDataSource1" onrowcommand="Feedcatmgmt_grid_RowCommand" 
            onrowupdating="Feedcatmgmt_grid_RowUpdating" DataKeyNames="ID">
            ...
            <Columns>
                <asp:BoundField DataField="Name" HeaderText="Feed category" />
