<%@ Page Language="C#" AutoEventWireup="true" CodeFile="weightmgmt.aspx.cs" Inherits="weightmgmt" %>
...
&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                <td class="style2" valign="top">
                    &nbsp;&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" 
                        Text="Weight group"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <br />
                    <asp:TextBox ID="Weight_edt" runat="server" Width="104px"></asp:TextBox>
    ...
    <p>
        <br />
        <asp:GridView ID="Weightmgmt_grid" runat="server" AutoGenerateColumns="False" 
            ...
            DataSourceID="SqlDataSource1" onrowcommand="Weightmgmt_grid_RowCommand" 
            onrowupdating="Weightmgmt_grid_RowUpdating" DataKeyNames="ID">
            ...
            <Columns>
                <asp:BoundField DataField="Name" HeaderText="Weight group, kg" />
                <asp:CommandField ShowEditButton="True" HeaderText="Edit" />
                <asp:ButtonField CommandName="Delete_weight" Text="Delete" />
            </Columns>
        </asp:GridView>
    </p>
