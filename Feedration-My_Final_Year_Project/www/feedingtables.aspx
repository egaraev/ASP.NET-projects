<%@ Page Language="C#" AutoEventWireup="true" CodeFile="feedingtables.aspx.cs" Inherits="energyexchange" %>
...
&nbsp;&nbsp;&nbsp;
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td class="style2" valign="top" style="margin-left: 40px">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label 
                        ID="Label9" runat="server" Text="Ratio"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label 
                        ID="Label10" runat="server" Text="Keeping Type"></asp:Label>
                    &nbsp;&nbsp;
                    <asp:Label 
                        ID="Label12" runat="server" Text="Season"></asp:Label>
                    <br />
                    <asp:DropDownList ID="Herd_ddl" runat="server" DataSourceID="SqlDataSource2" 
                        DataTextField="NAME" DataValueField="ID" Height="22px" Width="113px">
                    </asp:DropDownList>
                    <asp:DropDownList ID="Target_ddl" runat="server" DataSourceID="SqlDataSource3" 
                        DataTextField="NAME" DataValueField="ID" Height="22px" Width="164px">
                    </asp:DropDownList>
                    ...
                    <asp:DropDownList ID="Ratio_ddl" runat="server" DataSourceID="SqlDataSource4" 
                        DataTextField="NAME" DataValueField="ID">
                    </asp:DropDownList>
                    <asp:DropDownList ID="type_ddl" runat="server" DataTextField="NAME" 
                        DataValueField="ID">
                        <asp:ListItem Value="0">Staled</asp:ListItem>
                        <asp:ListItem Value="1">Grazing</asp:ListItem>
                    </asp:DropDownList>
                    <asp:TextBox ID="weight_edt" runat="server" Width="69px" Visible="False"></asp:TextBox>
                    <asp:DropDownList ID="season_ddl" runat="server" DataTextField="NAME" 
                        DataValueField="ID">
                        <asp:ListItem Value="0">Warm</asp:ListItem>
                        <asp:ListItem Value="1">Cold</asp:ListItem>
                    </asp:DropDownList>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:DBpath %>" 
                        SelectCommand="SELECT [ID], [NAME] FROM [FEEDRATIO]"></asp:SqlDataSource>
    ...
    <p>
        ...
        <asp:GridView ID="Energymgmt_grid" runat="server" AutoGenerateColumns="False" 
            ...
            Style="margin-top: 0px" Width="1094px" AllowPaging="True" 
            ...
            <Columns>
                    ...
                    <EditItemTemplate>
                        <asp:DropDownList ID="Targetcat_grid_ddl" runat="server" DataSourceID="SqlDataSource3"
                            DataTextField="NAME" DataValueField="ID">
                        </asp:DropDownList>
                    </EditItemTemplate>
                    <HeaderTemplate>
                ...
                <asp:TemplateField Visible="True">
                    ...
                    <EditItemTemplate>
                        <asp:DropDownList ID="Ratio_grid_ddl" runat="server" DataSourceID="SqlDataSource4"
                            DataTextField="NAME" DataValueField="ID">
                        </asp:DropDownList>
                    </EditItemTemplate>
                    <HeaderTemplate>
                    ...
                    <asp:BoundField DataField="TYPE" HeaderText="Grasing type" 
                        SortExpression="TYPE" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT ENERGYCHANGE.ID, ENERGYCHANGE.TARGETINCREASEID, ENERGYCHANGE.ANIMALSID, ANIMALS.NAME AS ANIMALSNAME, TARGETINCREASE.NAME AS TARGETINCREASENAME, ENERGYCHANGE.DRYMATTER, ENERGYCHANGE.CRUDEFIBER, ENERGYCHANGE.PROTEIN, ENERGYCHANGE.ENERGY, ENERGYCHANGE.CA, ENERGYCHANGE.P, ENERGYCHANGE.RATIOID AS RATIO, ENERGYCHANGE.TYPE, ENERGYCHANGE.WEIGHTPERCENT, ENERGYCHANGE.SEASON, FEEDRATIO.NAME AS RATIONAME FROM ENERGYCHANGE INNER JOIN TARGETINCREASE ON ENERGYCHANGE.TARGETINCREASEID = TARGETINCREASE.ID INNER JOIN ANIMALS ON ENERGYCHANGE.ANIMALSID = ANIMALS.ID INNER JOIN FEEDRATIO ON ENERGYCHANGE.RATIOID = FEEDRATIO.ID"></asp:SqlDataSource>
    </form>
</body>
    <p>
