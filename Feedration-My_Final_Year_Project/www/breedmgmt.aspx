<%@ Page Language="C#" AutoEventWireup="true" CodeFile="breedmgmt.aspx.cs" Inherits="breedmgmt" %>
...
&nbsp;&nbsp;&nbsp;
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td class="style2" valign="top">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label 
                        ID="Label1" runat="server" Text="Breed"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <br />
                    <asp:TextBox ID="Breed_edt" runat="server" Width="104px"></asp:TextBox>
    ...
    <p>
        <br />
        <asp:GridView ID="Breedmgmt_grid" runat="server" AutoGenerateColumns="False" 
            ...
            DataSourceID="SqlDataSource1" onrowcommand="Breedmgmt_grid_RowCommand" 
            onrowupdating="Breedmgmt_grid_RowUpdating" DataKeyNames="ID">
            ...
            <Columns>
                <asp:BoundField DataField="Name" HeaderText="Breed group" />
                <asp:CommandField ShowEditButton="True" HeaderText="Edit" />
                <asp:ButtonField CommandName="Delete_breed" Text="Delete" />
            </Columns>
        </asp:GridView>
    </p>
