        ...
        <table border="1" width="100%">
            <tr>
                <td align="right" class="style1">
                    <asp:Label ID="Login_lb" runat="server" Text="Логин : "></asp:Label>&nbsp;&nbsp;&nbsp;
                </td>
                <td>
            ...
            <tr>
                <td align="right" class="style1">
                    <asp:Label ID="Password_lb" runat="server" Text="Пароль : "></asp:Label>&nbsp;&nbsp;&nbsp;
                </td>
                <td>
            ...
            <tr>
                <td colspan="2" align="center">
                    <asp:Button ID="Button1" runat="server" Text="Войти" Width="90px" 
