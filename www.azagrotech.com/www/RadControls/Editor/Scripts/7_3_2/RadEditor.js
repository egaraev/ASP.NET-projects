...
var _76=new RegExp("((href|src)\\s*=\\s*('|\")?)(.*?)(\\3)(\\s|(\\/)?>)","ig");
_75=_75.replace(_76,"$2=$3$4$3 originalAttribute=\"$2\" originalPath=\"$4\"$6");
return _75;
...
var _5c=[];
var _5d=_5b.parentNode;
if(_5d!=null){
for(var i=0;i<_5b.childNodes.length;i++){
_5c[_5c.length]=_5b.childNodes[i].cloneNode(true);
}
for(var i=0;i<_5c.length;i++){
_5d.insertBefore(_5c[i],_5b);
}
_5d.removeChild(_5b);
return _5d;
}
return true;
},GetHtmlContent:function(_5f){
var _60=null;
if(_5f.tagName.toLowerCase()=="html"){
_60=_5f.getElementsByTagName("BODY")[0];
}else{
_60=_5f;
}
if(window.RadControlsNamespace.Browser.IsIE){
if(_60&&(_60.firstChild)&&("P"==_60.firstChild.tagName)&&(_60.childNodes.length==1)&&(_60.innerHTML.substring(0,3).toLowerCase()=="<p>")){
this._removeNode(_60.firstChild);
}
}else{
if(_60&&(_60.childNodes.length==1)&&(_60.firstChild.tagName)&&("br"==_60.firstChild.tagName.toLowerCase())){
_60.innerHTML="";
}
}
return _5f;
...
RadEditorNamespace.IECleanAnchorsFilter.prototype={GetHtmlContent:function(_61){
var _62=document.location.href;
var re=new RegExp("(<A[^<>]*?(href)\\s*=\\s*['\"])("+_62+")(\\#[^'\"]*?['\"][^>]*?>)","ig");
var _64=_61.replace(re,"$1$4");
return _64;
}};
...
RadEditorNamespace.MozEmStrongFilter.prototype={GetHtmlContent:function(_65){
var _66=_65.replace(new RegExp("<b(\\s([^>])*?)?>","ig"),"<strong$1>");
_66=_66.replace(new RegExp("</b(\\s([^>])*?)?>","ig"),"</strong$1>");
_66=_66.replace(new RegExp("<i(\\s([^>])*?)?>","ig"),"<em$1>");
_66=_66.replace(new RegExp("</i(\\s([^>])*?)?>","ig"),"</em$1>");
return _66;
},GetDesignContent:function(_67){
var _68=_67.replace(new RegExp("<strong(\\s([^>])*?)?>","ig"),"<b$1>");
_68=_68.replace(new RegExp("</strong(\\s([^>])*?)?>","ig"),"</b$1>");
_68=_68.replace(new RegExp("<em(\\s([^>])*?)?>","ig"),"<i$1>");
_68=_68.replace(new RegExp("</em(\\s([^>])*?)?>","ig"),"</i$1>");
return _68;
}};
...
RadEditorNamespace.MozillaKeepStylesString.prototype={GetDesignContent:function(_69){
var _6a=this;
var _6b=function(_6c,_6d,_6e,_6f,_70){
var _71=_70.indexOf("</head>",_6f);
if(_71!=-1&&_70.indexOf("<body",_71)!=-1){
return _6c;
}else{
_6a.markerCounter++;
var _72="RadEditorStyleKeeper"+_6a.markerCounter;
var _73="<div id='"+_72+"' style='display:none;'>&nbsp;</div><"+_6d+" reoriginalpositionmarker='"+_72+"'"+_6e;
return _73;
}
};
var _74=new RegExp("<(link|style)([^>]*>)","gi");
var _75=_69.replace(_74,_6b);
return _75;
}};
...
RadEditorNamespace.MozillaKeepStylesDom.prototype={GetHtmlContent:function(_76){
var _77=_76.getElementsByTagName("HEAD")[0];
if(!_77){
_77=_76.ownerDocument.getElementsByTagName("HEAD")[0];
}
if(!_77){
return _76;
}
var _78=_77.getElementsByTagName("STYLE");
var _79=_77.getElementsByTagName("LINK");
this._divs=_76.getElementsByTagName("DIV");
var i=0;
this._changed=false;
while(_78.length>0&&i<_78.length){
this._restoreElement(_78[i++]);
if(this._changed){
this._changed=false;
_78=_77.getElementsByTagName("STYLE");
this._divs=_77.getElementsByTagName("DIV");
i=0;
}
}
var i=0;
this._changed=false;
while(_79.length>0&&i<_79.length){
this._restoreElement(_79[i++]);
if(this._changed){
this._changed=false;
_79=_77.getElementsByTagName("LINK");
this._divs=_77.getElementsByTagName("DIV");
i=0;
}
}
if(this._divs){
for(var j=this._divs.length-1;j>=0;j--){
var _7c=this._divs[j];
...
this._divs=null;
_78=_76.ownerDocument.getElementsByTagName("STYLE");
if(_78){
for(var j=_78.length-1;j>=0;j--){
_78[j].removeAttribute("reoriginalpositionmarker");
}
}
_79=_76.ownerDocument.getElementsByTagName("LINK");
if(_79){
for(var j=_79.length-1;j>=0;j--){
_79[j].removeAttribute("reoriginalpositionmarker");
}
}
return _76;
},_restoreElement:function(_7e){
var _7f=_7e.getAttribute("reoriginalpositionmarker");
if(_7f){
_7e.removeAttribute("reoriginalpositionmarker");
this._changed=true;
j=0;
var _80=null;
while(j<this._divs.length&&!_80){
if(this._divs[j].id==_7f){
_80=this._divs[j];
}
j++;
}
if(_80){
var _81=_7e.parentNode;
var _82=_80.parentNode;
_81.removeChild(_7e);
_82.replaceChild(_7e,_80);
}else{
var _81=_7e.parentNode;
_81.removeChild(_7e);
}
...
RadEditorNamespace.MozillaKeepFlashString=function(_83){
this.IsDom=false;
this.Enabled=true;
...
this._flashImageSrc=_83?_83:"FlashManager.gif";
};
RadEditorNamespace.MozillaKeepFlashString.prototype={GetDesignContent:function(_84){
var _85=this;
var _86=function(_87,gr1,gr2,gr3,str,_8c){
var _8d="<img isflash=\"true\" "+gr1+" />"+gr2;
_8d=_8d.replace(/\ssrc=/gi," src=\""+_85._flashImageSrc+"\" flashSrc=");
return _8d;
};
var _8e=new RegExp("<embed([^>]*)?>(.*)?(<\\/embed>)?","ig");
var _8f=_84.replace(_8e,_86);
return _8f;
}};
...
RadEditorNamespace.MozillaKeepFlash.prototype={GetHtmlContent:function(_90){
if(!_90){
return _90;
}
var _91=_90.getElementsByTagName("IMG");
for(var i=0;i<_91.length;i++){
var _93=_91[i];
var _94=_93.getAttribute("isflash");
if(_94!=null){
var _95=_93.getAttribute("flashSrc");
var _96=RadEditorNamespace.Utils.GetOuterHtml(_93);
_96=_96.replace(/<img/gi,"<embed");
var _97=_93.ownerDocument.createElement("DIV");
_97.innerHTML=_96;
newNode=_97.firstChild;
if(_95){
newNode.src=_95;
if(window.RadControlsNamespace.Browser.IsSafari){
newNode.setAttribute("src",_95);
}
}
newNode.removeAttribute("flashSrc");
newNode.removeAttribute("isflash");
var _98=_93.parentNode;
_98.insertBefore(newNode,_93);
_98.removeChild(_93);
i--;
}
}
...
RadEditorNamespace.StripJunkFilter.prototype={GetHtmlContent:function(_99){
var _9a=_99;
if(window.RadControlsNamespace.Browser.IsSafari){
_9a=_9a.replace(new RegExp(" class=\"khtml-block-placeholder\"","ig"),"");
_9a=_9a.replace(new RegExp(" class=\"Apple-style-span\"","ig"),"");
_9a=_9a.replace(new RegExp(" class=\"webkit-block-placeholder\"","ig"),"");
}
if(window.RadControlsNamespace.Browser.IsFirefox){
_9a=_9a.replace(new RegExp("\\s?<br type=\"_moz\" \\/>","ig")," ");
_9a=_9a.replace(new RegExp(" _moz_[a-z_]*=\"[^\"]*\"","ig"),"");
_9a=_9a.replace(new RegExp(" type=\"_moz\"","ig"),"");
}
return _9a;
}};
...
},GetHtmlContent:function(_9c){
var _9d=_9c.ownerDocument;
var _9e=_9d.createElement("SPAN");
var _9f,_a0,_a1;
var _a2=_9c.getElementsByTagName("FONT");
while(_a2.length>0){
_a0=_a2[0];
_a1=_a0.parentNode;
_9f=_9e.cloneNode(false);
RadEditorNamespace.Utils.MergeElementAttributes(_a0,_9f,false);
if(_a0.style.cssText&&_a0.style.cssText!=""){
_9f.style.cssText=_a0.style.cssText;
}
if(_a0.className){
_9f.className=_a0.className;
}
if(_a0.face){
_9f.style.fontFamily=_a0.face;
}
var _a3=0;
if(_a0.style.fontSize){
_9f.style.fontSize=_a0.style.fontSize;
}else{
if(!isNaN(_a3=parseInt(_a0.size))&&_a0.size!="+0"){
try{
if(_a3<0){
_a3=_a3+4;
}
_9f.style.fontSize=this._fontSizes[_a3-1];
}
catch(ex){
_9f.style.fontSize=this._fontSizes[3];
}
}
}
if(_a0.color){
_9f.style.color=_a0.color;
}
if(window.RadControlsNamespace.Browser.IsIE&&_a0.innerHTML==" "){
_9f.innerText=_a0.innerHTML;
}else{
RadEditorNamespace.Utils.setElementInnerHtml(_9f,_a0.innerHTML);
}
_a1.replaceChild(_9f,_a0);
_a2=_9c.getElementsByTagName("FONT");
}
return _9c;
},GetDesignContent:function(_a4){
var _a5=_a4.ownerDocument;
var _a6=_a5.createElement("FONT");
var _a7,_a8,_a9;
var _aa=_a4.getElementsByTagName("SPAN");
while(_aa.length>0){
_a7=_aa[0];
_a9=_a7.parentNode;
_a8=_a6.cloneNode(false);
RadEditorNamespace.Utils.MergeElementAttributes(_a7,_a8,false);
if(_a7.style.cssText&&_a7.style.cssText!=""){
_a8.style.cssText=_a7.style.cssText;
}
if(_a7.className){
_a8.className=_a7.className;
}
if(_a7.style.fontFamily){
_a8.face=_a7.style.fontFamily;
if(window.RadControlsNamespace.Browser.IsIE){
_a8.style.removeAttribute("fontFamily");
}else{
_a8.style.fontFamily=null;
}
}
if(_a7.style.fontSize){
var _ab=3;
var _ac=this._fontSizesRev[parseInt(_a7.style.fontSize)];
if(typeof (_ac)!="undefined"){
_a8.size=_ac+1;
this._removeElementStyleAttribute(_a8,"fontSize");
}
}
if(_a7.style.color){
if(window.RadControlsNamespace.Browser.IsIE){
_a8.color=_a7.style.color;
_a8.style.removeAttribute("color");
}
}
if(window.RadControlsNamespace.Browser.IsIE&&_a7.innerHTML==" "){
_a8.innerText=_a7.innerHTML;
}else{
RadEditorNamespace.Utils.setElementInnerHtml(_a8,_a7.innerHTML);
}
_a9.replaceChild(_a8,_a7);
_aa=_a4.getElementsByTagName("SPAN");
}
return _a4;
},_removeElementStyleAttribute:function(_ad,_ae){
if(_ad.style&&_ad.style[_ae]){
_ad.style[_ae]=null;
if(_ad.style.removeAttribute){
_ad.style.removeAttribute(_ae);
}
if(_ad.style.cssText){
}else{
_ad.removeAttribute("style");
}
}
}};
...
},GetHtmlContent:function(_af){
if(!_af){
return "";
}
var sb=new RadEditorNamespace.Utils.StringBuilder("");
this._appendNodeXhtml(_af,sb);
return sb.ToString();
},_convertAttribute:function(s){
return String(s).replace(/\&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\"/g,"&quot;");
},_getAttributeValue:function(_b2,_b3,sb){
var _b5=_b2.nodeName;
var _b6=_b2.nodeValue;
if(window.RadControlsNamespace.Browser.IsIE&&(_b5=="type"||_b5=="value"||_b5=="selected")){
if(!_b6){
return;
}
}else{
...
if(!isNaN(_b6)){
_b6=_b3.getAttribute(_b5);
}
if(window.RadControlsNamespace.Browser.IsIE&&(_b5=="href"||_b5=="src")){
_b6=_b3.getAttribute(_b5,2);
}
sb.Append(" "+(_b2.expando?_b5:_b5.toLowerCase())+"=\""+this._convertAttribute(_b6)+"\"");
}else{
var _b8=_b3.style.cssText;
if(_b8){
sb.Append(" style=\""+this._convertAttribute(_b8.toLowerCase())+"\"");
}
}
},_canHaveChildren:function(_b9){
switch(_b9.tagName.toUpperCase()){
case "AREA":
case "BASE":
case "BASEFONT":
case "COL":
...
return true;
},_appendElementNode:function(_ba,sb){
if(_ba.tagName.charAt(0)=="/"){
return;
}
if(_ba.nodeName=="!"){
sb.Append(_ba.text);
...
var _bc=_ba.nodeName;
if(_ba.scopeName){
if(_ba.scopeName=="HTML"){
_bc=_bc.toLowerCase();
}else{
_bc=_ba.scopeName+":"+_bc;
}
}else{
_bc=_bc.toLowerCase();
}
...
if(window.RadControlsNamespace.Browser.IsIE){
if("img"==_bc){
var _bd=document.createElement("IMG");
_bd.mergeAttributes(_ba);
if(_bd.width){
sb.Append(" width=\""+_ba.getAttribute("width",2)+"\"");
}
if(_bd.height){
sb.Append(" height=\""+_ba.getAttribute("height",2)+"\"");
}
if(_bd.getAttribute("alt").length==0){
sb.Append(" alt=\""+_bd.getAttribute("alt")+"\"");
}
}else{
if("area"==_bc||"a"==_bc){
if(_ba.shape){
sb.Append(" shape=\""+_ba.shape.toLowerCase()+"\"");
}
if(_ba.coords){
sb.Append(" coords=\""+_ba.getAttribute("coords")+"\"");
}
if(_ba.href){
var _be=_ba.getAttribute("href",2).replace("about:blank","");
_be=_be.replace("about:","");
sb.Append(" href=\""+_be+"\"");
_ba.removeAttribute("href",0);
}
}
}
}
try{
var _bf=_ba.attributes;
var l=_bf.length;
for(var i=0;i<l;i++){
this._getAttributeValue(_bf[i],_ba,sb);
}
}
catch(exc){
}
switch(_bc){
case "script":
sb.Append(">"+_ba.text+"</"+_bc+">");
break;
case "textarea":
sb.Append(">"+_ba.value+"</"+_bc+">");
break;
case "iframe":
sb.Append("></iframe>");
break;
...
if(window.RadControlsNamespace.Browser.IsIE){
_c2=_c2.replace(/\soriginalAttribute="[^"]+"/gi,"");
_c2=_c2.replace(/\soriginalPath="[^"]+"/gi,"");
}
sb.Append(_c2);
sb.Append("</object>");
break;
...
case "comment":
case "noscript":
var _c2=_ba.innerHTML;
if(window.RadControlsNamespace.Browser.IsIE&&_c2.length==0){
_c2=_ba.ownerDocument.title;
}
sb.Append(">"+_c2+"</"+_bc+">");
break;
default:
if(_ba.hasChildNodes()||(true==_ba.canHaveChildren||(_ba.canHaveChildren==null&&this._canHaveChildren(_ba)))){
sb.Append(">");
var cs=_ba.childNodes;
l=cs.length;
for(var i=0;i<l;i++){
...
},_appendTextNode:function(_c4,sb){
var _c6=String(_c4.nodeValue);
var _c7=_c4.parentNode.nodeName.toLowerCase();
if(!window.RadControlsNamespace.Browser.IsIE&&(_c7=="style"||_c7=="script")){
sb.Append(_c6);
}else{
_c6=_c6.replace(/\&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");
if(window.RadControlsNamespace.Browser.IsFirefox){
_c6=_c6.replace(/[\u00a0]/g,"&nbsp;");
}
sb.Append(_c6);
}
},_appendCDataNode:function(_c8,sb){
sb.Append("<![CDA"+"TA[\n"+_c8.nodeValue+"\n]"+"]>");
},_appendCommentNode:function(_ca,sb){
var _cc=_ca.nodeValue;
if(!_cc&&_ca.text){
_cc=_ca.text;
}else{
_cc="<!--"+_cc+"-->";
...
sb.Append(_cc);
},_appendNodeXhtml:function(_cd,sb){
if(_cd.uniqueID){
if(this._uniqueIds[_cd.uniqueID]){
return;
}else{
this._uniqueIds[_cd.uniqueID]=true;
}
}
switch(_cd.nodeType){
case 1:
this._appendElementNode(_cd,sb);
break;
case 3:
this._appendTextNode(_cd,sb);
break;
case 4:
this._appendCDataNode(_cd,sb);
break;
case 8:
this._appendCommentNode(_cd,sb);
break;
}
}};
...
var _cf="P|DIV|H1|H2|H3|H4|H5|H6|ADDRESS|PRE|OL|UL|LI|TITLE|META|LINK|BASE|SCRIPT|LINK|TD|TH|AREA|OPTION";
var _d0="HTML|HEAD|BODY|STYLE|FORM|TABLE|TBODY|THEAD|TR";
var _d1=_d0+"|UL|OL";
this._ignoreTags=new RegExp("(<PRE[^>]*>|<!--)([\\s\\S]*?)(<\\/PRE>|-->)","gi");
this._tagsNLBefore=new RegExp("<("+_cf+")[^>]*>","gi");
this._tagsNLAfter=new RegExp("<\\/("+_cf+")[^>]*>","gi");
this._tagsNLNoCloseAfter=new RegExp("<(BR|HR)[^>]*\\/?>","gi");
this._tagsNLBeforeAndAfter=new RegExp("<\\/?("+_d0+")[^>]*>","gi");
this._tagsIncIndent=new RegExp("^<("+_d1+")[\\s\\/>]","i");
this._tagsDecIndent=new RegExp("^<\\/("+_d1+")[\\s\\>]","i");
this._shrinkNL=new RegExp("\\s*\\n+\\s*","gi");
};
RadEditorNamespace.IndentHTMLContentFilter.prototype={dispose:function(){
this._protectedData=[];
},GetHtmlContent:function(_d2){
var _d3=RadEditorNamespace.Utils.Trim(_d2);
if(_d3.indexOf("<body")==0){
_d3=_d3.substring(_d3.indexOf(">")+1,_d3.length-7);
}
this._protectedData=[];
var _d4=this;
var _d5=function(_d6,_d7,_d8,_d9,_da,_db){
_d4._protectedData[_d4._protectedData.length]=_d8;
return _d7+"RADEDITORFORMATTED_"+_d4._protectedData.length+_d9;
};
_d2=_d2.replace(this._ignoreTags,_d5);
var _dc="$&";
if(window.RadControlsNamespace.Browser.IsSafari){
_dc="$0";
}
_d3=_d3.replace(this._tagsNLBefore,"\n"+_dc);
_d3=_d3.replace(this._tagsNLAfter,_dc+"\n");
_d3=_d3.replace(this._tagsNLNoCloseAfter,_dc+"\n");
_d3=_d3.replace(this._tagsNLBeforeAndAfter,"\n"+_dc+"\n");
var _dd=_d3.split(this._shrinkNL);
var _de=new RadEditorNamespace.Utils.StringBuilder("");
var _df="";
...
if(this._tagsDecIndent.test(_e1)){
if(_df.length>this._indentPattern.length){
_df=_df.substring(this._indentPattern.length);
}else{
_df="";
}
}
...
_de.Append(_e1);
_de.Append("\n");
if(this._tagsIncIndent.test(_e1)){
_df+=this._indentPattern;
}
}
_d3=_de.ToString();
for(var i=0;i<this._protectedData.length;i++){
var _e2=new RegExp("RADEDITORFORMATTED_"+(i+1));
_d3=_d3.replace(_e2,this._protectedData[i]);
}
return _d3;
}};
RadEditorNamespace.MakePathsAbsolute=function(_e3){
this.IsDom=true;
this.Enabled=true;
...
RadEditorNamespace.MakePathsAbsolute.prototype={GetHtmlContent:function(_e4){
if("href"==this.attrName){
this._updateElements(_e4,"A","href");
this._updateElements(_e4,"AREA","href");
}else{
if("src"==this.attrName){
this._updateElements(_e4,"IMG","src");
this._updateElements(_e4,"EMBED","src");
}
}
return _e4;
},_getElements:function(_e5,_e6){
var _e7=_e5.getElementsByTagName(_e6);
if(!_e7){
_e7=_e5.ownerDocument.getElementsByTagName(_e6);
}
return _e7;
},_updateElements:function(_e8,_e9,_ea){
var _eb=_e8.ownerDocument.createElement("div");
var _ec=this._getElements(_e8,_e9);
if(_ec){
for(var i=0;i<_ec.length;i++){
if("href"==_ea){
_eb.innerHTML="<a href=\""+_ec[i].getAttribute("href",2).replace(/\"/gi,"%22")+"\">test</a>";
_ec[i].setAttribute("href",_eb.childNodes[0].href);
}else{
_eb.innerHTML="<img src=\""+_ec[i].getAttribute("src",2).replace(/\"/gi,"%22")+"\" />";
_ec[i].setAttribute("src",_eb.childNodes[0].src);
}
}
}
_eb.innerHTML="";
...
RadEditorNamespace.RadStripPathFilter=function(_ee,_ef){
this.Name="RadStripPathFilter";
this.Description="This filter strips an image or an anchor path";
this.TagName=_ee;
this.PathToStrip=_ef;
this.GetHtmlContent=function(_f0){
if(!document.all){
return _f0;
}else{
var _f1=StripAbsolutePaths(_f0,this.TagName,this.PathToStrip);
return _f1;
}
return _f0;
};
function StripAbsolutePaths(_f2,_f3,_f4){
var _f5=function(_f6,_f7,_f8,_f9){
_f9=RadEditorNamespace.Utils.EscapeRegexSpecialChars(_f9);
var _fa=new RegExp("(<"+_f7+"[^<>]*?("+_f8+")\\s*=\\s*['\"])("+_f9+")([^'\"]*?['\"][^>]*?>)","ig");
return _f6.replace(_fa,"$1$4");
};
var _fb=function(_fc,_fd,_fe){
if(_fd=="A"){
var _ff=document.location.href;
_ff=RadEditorNamespace.Utils.EscapeRegexSpecialChars(_ff);
var re=new RegExp("(<A[^<>]*?(href)\\s*=\\s*['\"])("+_ff+")(\\#[^'\"]*?['\"][^>]*?>)","ig");
_fc=_fc.replace(re,"$1$4");
}
var _101=_fc;
var _102=(_fd=="A"?"href":"src");
for(var i=0;i<_fe.length;i++){
if(_fe[i]){
_101=_f5(_101,_fd,_102,_fe[i]);
}
}
return _101;
};
...
var _105=window.location;
_104[0]=_105.protocol+"//"+_105.host+(_105.port?":"+_105.port:"");
var _106=_105.pathname;
var _107=_106.lastIndexOf("/");
if(_107>-1){
_104[1]=_106.substr(0,_107+1);
}
}
return _fb(_f2,_f3,_104);
}
