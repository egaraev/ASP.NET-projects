<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Contentheader.aspx.cs" Inherits="admin_Contentheader" %>
...
<body>
    ...
    <div>
        <table width="100%" cellpadding="10" cellspacing="10" border="0">
            ...
            <tr>
                <td>
                    <asp:Button ID="Add_btn" runat="server" Text="Обновить" Width="126px" OnClick="Add_btn_Click" />
                    &nbsp;&nbsp;&nbsp;&nbsp;
