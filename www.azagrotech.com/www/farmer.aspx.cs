...
public partial class farmer : System.Web.UI.Page
{
    ...
    {
        SqlDataSource7.SelectCommand="SELECT TI.ID AS ID, TI.NAME AS NAME FROM TARGETINCREAE TI, ENERGYCHANGE EC WHERE TI.ID=EC.TARGETINCREASEID AND EC.ANIMALSID=@ANIMALS";
